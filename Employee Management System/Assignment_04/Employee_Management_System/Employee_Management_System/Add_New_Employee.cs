...
namespace Employee_Management_System
{
    public partial class frm_Add_New_Employee : Form
    {
        ...
        {
            if (tb_ID.Text != "" && tb_Name.Text != "" && tb_Salary.Text != "" && cmb_Department.Text != "")
            {
                Con_Open();
                ...
                Cmd.CommandText = "Insert into Employee_Details (ID,Name,DOB,Salary,Depertment) VALUES (@ID,@Name,@DOB,@Salary,@Depertment)";

...
namespace Employee_Management_System
{
    public partial class frm_Search_Employee_Details : Form
    {
        ...
        {
            DialogResult Res = MessageBox.Show("Are you Sure you want to Log Out ??", "Logging Out", MessageBoxButtons.YesNo);
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
            if (tb_ID.Text != "")
            {
                ...
                {
                    MessageBox.Show("Information is not Availale which You are searching", "No Record Found", MessageBoxButtons.OK);
                    Clear_Controls();
                }
